...
class MyordersController extends Controller {
    ...
    public function buyingorders(Request $request){ 
        ...
        $allrecords  = Myorder::with('Gig.User')->where('buyer_id', auth()->id())->orderBy('id', 'DESC')->get();
        // dd($allrecords);
    ...
    public function workplace(Request $request, $slug) {       
        ...
        return view('myorders.workplace', ['title' => $pageTitle, 'orderInfo'=>$orderInfo, 'gigInfo'=>$gigInfo, 'gigmessages'=>$gigmessages]);
    }
