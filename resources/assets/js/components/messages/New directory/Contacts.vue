                    ...
                    <div class="message_left_part">
                        ...
                        <div class="contacts-list">
                            <ul>
                                ...
                                <li :class="selectedContact == contact ? 'active' : '' " v-for="contact in sortedContacts" :key="contact.id" @click="selected(contact)">    
                                    <div class="avatar">
                                    ...
                                    <div class="contact">
                                        ...
                                        <p class="email" >{{contact.last_message.message | trunc}} </p> 
                                    </div>

                                    <span class="date"> {{contact.last_message.created_at | myDate2}}</span>
