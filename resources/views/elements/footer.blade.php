...
<!--                        <li><a href="#">Email</a></li>-->
                ...
                <div class="foot_menu block5">
                    <ul>
                        ...
                        @if($siteSettings->twitter_link)
                            <li><a href="{!! $siteSettings->twitter_link !!}" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i> twitter</a></li>
                        @endif
    ...
    <div class="footer_adat"> © Copyright @ {!! date('Y') !!} &nbsp;|&nbsp;  <a href="https://www.preffort.com/" target="_blank">Marketplace Service Platform</a> – Preffort. All Rights Reserved</div>
</footer>
