...
<!--{{ HTML::script('public/js/jquery.validate.js'), 'defer'}}-->
    ...
    <section class="dashboard-section">
        <div class="container">
            <div class="row">
                ...
                <div class="gig_from">
                    {{ Form::open(array('method' => 'post', 'name' => 'gigform', 'id' => 'gigform', 'class' => 'form form-signin', 'enctype'=>'multipart/form-data')) }}  
                    ...
                    <div class="step_form_inner step_account1" id="gig_overview">
                        ...
                        <div class="form_field">
                            ...
                            <div class="right_filed half_field">
                                ...
                                <span class="drop_down_arow" id="subcategory">
                                    {{Form::select('subcategory_id', array(),null, ['class' => 'form-control required','placeholder' => 'Select Sub Category'])}}
                                </span>
                            </div>
                        </div>   
                        <div class="form_field">
                        ...
                        <div class="page_btn page_btn_creat">
                            ...
                            {{Form::submit('Save &amp; Continue', ['class' => 'btn btn-info', 'disabled'=>'disabled', 'id'=>'step_2'])}}
                        </div>
                    </div> 
