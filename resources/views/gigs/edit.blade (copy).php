                    ...
                    {{Form::model($gigDetail, ['method' => 'post', 'name' => 'gigform', 'id' => 'gigform', 'enctype' => "multipart/form-data"]) }} 
                        ...
                        <div class="step_form_inner second_page step_account2" id="gig_package">
                            ...
                            <div class="row" id="standard" <?php if($gigDetail->gig_fixed_price == null) { ?> style="display:block;" <?php } else { ?> style="display:none;" <?php } ?>>
                                ...
                                <div class="another "><a href="javascript:void(0)" style="padding-left: 12px; text-decoration:none;" class="add_button" ><b>+</b> Add New Custom Field</a></div>
