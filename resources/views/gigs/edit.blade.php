                    ...
                    {{Form::model($gigDetail, ['method' => 'post', 'name' => 'gigform', 'id' => 'gigform', 'enctype' => "multipart/form-data"]) }} 
                        ...
                        <div class="step_form_inner step_account1" id="gig_overview">
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <div class="gig_loader"  style="display: none;" id="loaderID">{{HTML::image("public/img/loading.gif", SITE_TITLE)}}</div>
                            </div>
                        </div>
                        <div class="step_form_inner second_page step_account2" id="gig_package">
                                  ...
                                  <div class="col-sm-8 md-8">
                                        <div class="form-group row proposal-price justify-content-center">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <?php global $package_price; ?>
                                                    {{Form::select('gig_fixed_price', $package_price,null, ['class' => 'form-control arrowed required','placeholder' => 'Select Price', 'id' => 'gig_fixed_price'])}}
                                            </div>
                                        ...
                                        <div class="form-group row proposal-price justify-content-center mb-4"><!--- form-group row Starts --->
                                            ...
                                            <?php global $revisions; ?>
                                                    {{Form::select('gig_fixed_revision', $revisions,null, ['class' => 'form-control arrowed required','placeholder' => 'Select', 'id' => 'gig_fixed_revision'])}}   
                                        ...
                                        <div class="form-group row proposal-price justify-content-center mb-4"><!--- form-group row Starts --->
                                            ...
                                            <?php global $delivery_days; ?>
                                                    {{Form::select('gig_fixed_delivery', $delivery_days,null, ['class' => 'form-control arrowed required','placeholder' => 'Delivery Time', 'id' => 'gig_fixed_del'])}}
                                    ...
                                    if (count($recordExtInfo) > 0) {
                                        ...
                                        foreach ($recordExtInfo as $ekey => $gigext) {
                                            ...
                                            <div id="extra_box_<?php echo $extno; ?>" class="answer_div answer_div_new">
                                                ...
                                                {{Form::text('exttitle', $gigext->title, ['name' => 'exttitle[' . $extno . ']', 'id' => 'faqextttl_' . $extno, 'class'=>'form-control faqques required', 'minlength' => 5, 'maxlength' => 80, 'placeholder'=>'Title your extra service', 'autocomplete'=>'OFF'])}}
                                                    </div>
                                                   <div class="gigs-inputs">
                                                {{Form::textarea('extdescription', $gigext->description, ['name' => 'extdescription[' . $extno . ']', 'id' => 'faqextdes_' . $extno, 'minlength' => 5, 'class'=>'form-control faqans texta required', 'placeholder'=>"Describe your offering"])}}
                                                    </div>
                                                    <div class="gigs-inputs">
                                                <div class="drop_arow">
                                                    <div class="market-select">
                                                        <span>
                                                    <?php global $delivery_days; ?>
                                                    {{Form::select('extdelivery', $delivery_days, $gigext->delivery, ['name' => 'extdelivery[' . $extno . ']', 'id' => 'faqextdel_' . $extno, 'class' => 'form-control required','placeholder' => 'Delivery Time'])}}
                                                </span>
                                                    </div>
                                                        </div>
                                                <div class="drop_arow">
                                                    <div class="market-select">
                                                        <span>
                                                    <?php global $package_price; ?>
                                                    {{Form::select('extprice', $package_price, $gigext->price, ['name' => 'extprice[' . $extno . ']', 'id' => 'faqextprc_' . $extno, 'class' => 'required form-control','placeholder' => 'Select Price'])}}
                                                        </span>
                                                    </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <!--<div class="gig_loader"  style="display: none;" id="loaderID"><img src="{{asset('public/img/loading.gif')}}" /></div>-->
                                <div class="gig_loader" style="display:none;" id="loaderID"><img src="{{asset('public/img/loading.gif')}}" /></div>
                            </div>
                        </div>
                                                ...
                                                <div class="accordion-section">
                                                    ...
                                                    <div id="accordion-<?php echo $currid; ?>" class="accordion-section-content">
                                                        <div class="form_fieldd">
                                                            {{Form::text('question', $gigfaqques->question, ['name' => 'question[]', 'id' => 'faqques_' . $currid, 'class'=>'form-control faqques required', 'minlength' => 5, 'maxlength' => 80, 'placeholder'=>'Add a Question: i.e. Do you translate to English as well?', 'autocomplete'=>'OFF'])}}
                                                            {{Form::textarea('answer', $gigfaqques->answer, ['name' => 'answer[]', 'id' => 'faqans_' . $currid, 'minlength' => 5, 'maxlength' => 300, 'class'=>'form-control faqans texta required', 'placeholder'=>"Add an Answer: i.e. Yes, I also translate from English to Hebrew."])}}
                                                            

                                                        </div>
                                                        <div class="text_btn">
                                                            <a class="trash_left" href="javascript:void(0);" onclick="deletefaq('<?php echo $currid; ?>')"><i class="fa fa-trash"></i> Delete</a>
                                                            {{Form::button('Cancel', ['class' => 'btn-standard btn-green-grad btn-cancel-faq', 'id'=>'faqcan_'.$currid, 'onclick'=>'cancelfaq('.$currid.')'])}}
                                                            {{Form::button('update', ['class' => 'btn-standard btn-white-grad btn-add-faq', 'id'=>'faqsub_'.$currid, 'onclick'=>'updatefaq('.$currid.')'])}}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="step_form_inner fifth_page step_account5" id="gig_gallery">
                                            ...
                                            <div class="shoe_imagrd_rgijt_img">
                                                <div class="shoe_imagrd_rgijt_img_minimg">
                                                    ...
                                                    @if(file_exists($filePath) && $value->name != '')
                                                        {{HTML::image(GIG_SMALL_DISPLAY_PATH.$value->name, SITE_TITLE,['id' => 'ShowImage' . $imgid, 'style'=>"max-width: 100%", 'class' => 'umg_ahe'])}}
                                                    @else 
                                                        {{HTML::image('public/img/front/no_image.png', SITE_TITLE,['id' => 'ShowImage' . $imgid, 'style'=>"max-width: 100%", 'class' => 'umg_ahe'])}}
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            <div class="gig_video">
                                ...
                                <div class="form_fieldd">
                                    {{Form::text('youtube_url', null, ['class'=>'yturl', 'autocomplete'=>'OFF'])}}
                                </div>
