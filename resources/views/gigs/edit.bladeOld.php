                    ...
                    {{Form::model($gigDetail, ['method' => 'post', 'name' => 'gigform', 'id' => 'gigform', 'enctype' => "multipart/form-data"]) }} 
                        ...
                        <div class="step_form_inner third_page step_account3" id="gig_description">
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <div class="gig_loader" id="des_ldr" style="display: none;" id="loaderID">{{HTML::image("public/img/loading.gif", SITE_TITLE)}}</div>
                            </div>
                        </div>
                        <div class="step_form_inner fourth_page step_account4" id="gig_requirement">
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <div class="gig_loader" id="req_ldr" style="display: none;" id="loaderID">{{HTML::image("public/img/loading.gif", SITE_TITLE)}}</div>
                            </div>
                        ...
                        <div class="step_form_inner fifth_page step_account5" id="gig_gallery">
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <div class="gig_loader" id="gal_ldr" style="display: none;" id="loaderID">{{HTML::image("public/img/loading.gif", SITE_TITLE)}}</div>
                            </div>
                        </div>
