...
//                    $('#ShowPdf3').attr('src', e.target.result);
        ...
        $(".close_btn1").on("click", function () {
            ...
            if (img) {
                $('#ShowImage1').attr('src','<?php echo HTTP_PATH.'./img/front/no_image.png' ?>');
            }
            $('.close_btn1').hide();
        ...
        $(".close_btn2").on("click", function () {
            ...
            if (img) {
                $('#ShowImage2').attr('src','<?php echo HTTP_PATH.'./img/front/no_image.png' ?>');
            }
            $('.close_btn2').hide();
        ...
        $(".close_btn3").on("click", function () {
            ...
            if (img) {
                $('#ShowImage3').attr('src','<?php echo HTTP_PATH.'./img/front/no_image.png' ?>');
            }
            $('.close_btn3').hide();
        ...
        $(".close_btn4").on("click", function () {
            ...
            if (img) {
                $('#ShowImage4').attr('src','<?php echo HTTP_PATH.'./img/front/no_image.png' ?>');
            }
            $('.close_btn4').hide();
                    ...
                    {{Form::model($gigDetail, ['method' => 'post', 'name' => 'gigform', 'id' => 'gigform', 'enctype' => "multipart/form-data"]) }} 
                        ...
                        <div class="step_form_inner second_page step_account2" id="gig_package">
                                ...
                                <div class="col-sm-6 md-6">
                                 ...
                                 <!--   	<button class="btn btn-xs btn-success active" style="color:#EFEFEF;  text-decoration:none; tag="span">YES</button>-->
                                    ...
                                    <div class="material-switch pull-right" >
                                        <span style="margin-right:5px;">Fixed Price : </span> <input id="someSwitchOptionSuccess" name="someSwitchOption001" type="checkbox" value="0" onclick="myFunction()"  />
                                  ...
                                  <div class="col-sm-8 md-8">
                                        <div class="form-group row proposal-price justify-content-center">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" form="pricing-form" name="proposal_price" min="5" >
                                            </div>
                                        ...
                                        <div class="form-group row proposal-price justify-content-center mb-4"><!--- form-group row Starts --->
                                            ...
                                            <select name="proposal_revisions" form="pricing-form" class="form-control arrowed" required="">
                                            <?php 
                                        ...
                                        <div class="form-group row proposal-price justify-content-center mb-4"><!--- form-group row Starts --->
                                            ...
                                            <select name="delivery_id" form="pricing-form" class="form-control arrowed" required="" >
                                            <option value="">Select Delivery Time</option>
                                            <?php 
                                              $delTimes = array(1,2,3,4,5,6,7);
                                              foreach ($delTimes as $key => $rev) {
                                                echo "<option value='$key' >$rev Days</option>";
                                              }
                                            ?>
                                            </select>
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <div class="gig_loader" id="pkg_ldr" style="display: none;" id="loaderID">{{HTML::image("./img/loading.gif", SITE_TITLE)}}</div>
                            </div>
                        </div>
                        <div class="step_form_inner third_page step_account3" id="gig_description">
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <div class="gig_loader" id="des_ldr" style="display: none;" id="loaderID">{{HTML::image("./img/loading.gif", SITE_TITLE)}}</div>
                            </div>
                        </div>
                        <div class="step_form_inner fourth_page step_account4" id="gig_requirement">
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <div class="gig_loader" id="req_ldr" style="display: none;" id="loaderID">{{HTML::image("./img/loading.gif", SITE_TITLE)}}</div>
                            </div>
                        ...
                        <div class="step_form_inner fifth_page step_account5" id="gig_gallery">
                                        ...
                                        <div class="form_row_fhr_cols" id="<?php echo $key; ?>imagediv">
                                            <div class="shoe_imagrd_rgijt_img">
                                                <div class="shoe_imagrd_rgijt_img_minimg">
                                                    ...
                                                    @else 
                                                        {{HTML::image('./img/front/no_image.png', SITE_TITLE,['id' => 'ShowImage' . $imgid, 'style'=>"max-width: 100%", 'class' => 'umg_ahe'])}}
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <div class="gig_loader" id="gal_ldr" style="display: none;" id="loaderID">{{HTML::image("./img/loading.gif", SITE_TITLE)}}</div>
                            </div>
                        </div>
                        <div class="step_form_inner fifth_page step_account6" id="gig_publish">
                            ...
                            <div class="page_btn">
                                ...
                                <div class="gig_loader" id="pub_ldr" style="display: none;" id="loaderID">{{HTML::image("./img/loading.gif", SITE_TITLE)}}</div>
                            </div>
                        </div>
                    {{ Form::close()}}
                </div>
