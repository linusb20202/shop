                        ...
                        <div class="col-sm-6 col-md-3" id="gigdiv{{$allrecord->id}}">
                                <div class="thumbnail my_savedgig">
                                    ...
                                    <div class="caption">
                                        ...
                                        <h3>
                                            <a href="{{ URL::to( 'gig-details/'.$allrecord->slug)}}">{{ str_limit($allrecord->title, $limit = 40, $end = '...') }} </a>
                                            <!--<a href="{{ URL::to( 'gig-details/'.$allrecord->slug)}}">{{ $allrecord->title}} </a>-->
                                        </h3>
                                        ...
                                        <div class="bottom_row">
                                            <div class="bottom_lft">
                                                @if($allrecord->offer_status == 0)
                                                    <a href="{{ URL::to('acceptreject/1/'.$allrecord->slug)}}" class="accept_off">Accept</a>
                                                    <a href="{{ URL::to('acceptreject/2/'.$allrecord->slug)}}" class="reject_off">Reject</a>
                                                @else 
