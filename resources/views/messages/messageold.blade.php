...
<link rel="stylesheet" type="text/css" href="{{ url(config('app.url')) }}/css/facebox.css">
<script type="text/javascript" src="{{ url(config('app.url')) }}/js/facebox.js"></script>
                                            ...
                                            <a href="{{URL::to('messages/message/'.$users['slug'])}}">
                                                <div class="user_imges">
                                                    ...
                                                    @if($users['profile_image'])
                                                        <img src="{{ url(config('app.url')) }}/files/users/small/{{$users['profile_image'] }}" />
                                                    @else
                                                        <img src="{{ url(config('app.url')) }}/img/front/user-img.png" />
                                                    @endif
