        ...
        <div class="container">
            <div class="workplace">
                ...
                <div class="req_dtl">
                    ...
                    <div class="req_row">
                        <label>Gig Title: </label> <span>{{$gigInfo->title}}</span>
                    </div>
                    <div class="req_row">
                        <label>Package: </label> <span>{{ucfirst($orderInfo->package)}}</span>
                    </div>
                    <div class="req_row">
                ...
                <div class="management-bx">
                    ...
                    <div class="workplace-seller sticky" id="app">
                        <div class="offer_dtl" >
                            @if($orderInfo->seller_id == Session::get('user_id'))
                            ...
                            <div class="dpimg-about_right">
                                <div class="buy_row">
                                    ...
                                    <div class="buy_name">
                                        <span><a href="{{ URL::to( 'public-profile/'.$orderInfo->Buyer->slug)}}">{{$orderInfo->Buyer->user_name}}</a></span>
                                        <div class="about-rating">
                                             <div style="display:flex; flex-direction:row; text-align:left !important; margin-top:10px; ">
                                                <gig-rating :rate="{{$orderInfo->Buyer->average_rating}}"></gig-rating>
                                                <span style="font-size:14px;"> <b> {{$orderInfo->Buyer->average_rating}}</b> ({{$orderInfo->Buyer->total_review}} Reviews)</span>
                                            </div>    
                            ...
                            <div class="dpimg-about_right">
                                <div class="buy_row">
                                    ...
                                    <div class="buy_name">
                                        <span><a href="{{ URL::to( 'public-profile/'.$orderInfo->Seller->slug)}}">{{$orderInfo->Seller->user_name}}</a></span>
                                        <div class="about-rating">
                                            <div style="display:flex; flex-direction:row; text-align:left !important; margin-top:10px; ">
                                                <gig-rating :rate="{{$orderInfo->Buyer->average_rating}}"></gig-rating>
                                                <span style="font-size:14px;"> <b> {{$orderInfo->Buyer->average_rating}}</b> ({{$orderInfo->Buyer->total_review}} Reviews)</span>
