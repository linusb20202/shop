                    ...
                    <div class="about_seller">
                        ...
                        <div class="profile-about">
                            ...
                            <div class="dp_details-about">
                                <h3><a href="{{ URL::to( 'public-profile/'.$recordInfo->User->slug)}}">{{$recordInfo->User->user_name ? $recordInfo->User->user_name : ''}} </a></h3>
                                <p>{{$recordInfo->User->address}}</p>
                                <div class="about-rating">
                                    
                                    <span class="req_rate"><i class="fa fa-star starred"></i><b>{{$recordInfo->User->average_rating}}</b> ({{$recordInfo->User->total_review}} reviews)</span>
                                </div>
                        ...
                        <div class="send-form">
                            ...
                            @if($recordInfo->status == 1)
                                ...
                                <div class="form-group offer_field">
                                    ...
                                    <div class="send_input">
                                    {{Form::text('deliver_in', null, ['class'=>'form-control required digits', 'placeholder'=>'days', 'autocomplete' => 'off'])}}
                                    </div>
                                    </div>
                                <div class="form-group offer_field">
