            ...
            <div class="row">
                <div class="col-sm-5 col-md-4">
                    <div class="profile-bx">
                        ...
                        <h2>@if(isset($recordInfo->user_name))
                                ...
                                <div class="management-bx-over">
                                    <div class="management-table">
                                        ...
                                        <div class="management-table-tr">
                                            ...
                                            <div class="management-table-td">{{$allrecord->Buyer->user_name}}</div>
                                ...
                                <div id="info{!! $allrecord->id !!}" style="display: none;" class="frnt_div">
                                    <div class="nzwh-wrapper">
                                        <fieldset class="nzwh">
                                            ...
                                            <div class="drt">
                                                <div class="admin_pop"><span>Buyer Name: </span>  <label>{!! $allrecord->Buyer->user_name !!}</label></div>
                                        ...
                                        <div class="management-table-tr">
                                            ...
                                            <div class="management-table-td">
                                                <div class="buyer-img">
                                                    ...
                                                    @else
                                                    <a href="{{ URL::to('public-profile/'.$allrecord->User->slug)}}" class="">{{HTML::image('./img/front/user-img.png', SITE_TITLE,['style'=>"max-width: 60px"])}}</a>
                                                    @endif
                                                </div>
                                            </div>
