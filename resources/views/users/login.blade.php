                ...
                <div class="login_fieldarea">
                    <div class="inputt">
                        <span class="fieldd"><i class="fa fa-envelope"></i>
                            {{Form::text('email_address', Cookie::get('user_email_address'), ['class'=>'form-control required  enterkey', 'placeholder'=>'Email address / Username', 'autocomplete'=>'OFF'])}}
                        </span>
                    </div>
                    <div class="inputt">
                    ...
                    <div class="sign_in" id="sub_btn_dive">
                        ...
                        <div class="loginbtnloader" id="btnloader"><img src="{{asset('public/img/loading.gif')}}" /></div>
                    </div>
                </div>
