                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="ch_paypalemail">
                            ...
                            {{ Form::open(array('method' => 'post', 'id' => 'changeemail')) }}
                            <div class="setting-input">
                                <div class="form-group">
                                    {{Form::text('paypal_email', $recordInfo->paypal_email, ['class'=>'form-control required email', 'placeholder'=>'Enter paypal email for payment', 'autocomplete' => 'off', 'id'=>'paypal_email'])}}
                            ...
                            <div class="form-group">
                                <div class="setting-btn">
                                    ...
                                    <div class="passloader" id="emailloader">{{HTML::image("public/img/loading.gif", SITE_TITLE)}}</div>
                                </div>
                            </div>
                            {{ Form::close()}}            
                        </div>
