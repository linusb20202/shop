...
*/?>
                        ...
                        ?>
                        <h2>{!! $recordInfo->user_name !!}</h2>
                        <div class="pub_rat">
                            <div style="display:flex; flex-direction:row; text-align:center !important; justify-content:center !important; ">
                                <gig-rating :rate="{{ $recordInfo->average_rating }}"></gig-rating><span style="font-size:14px;">{{$recordInfo->average_rating}} ({{ $recordInfo->total_review }} Reviews)</span>
                            </div>    
                                        ...
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <div class="bottom_row">
                                                   ...
                                                   @else
                                                        <a href="{{ URL::to( 'gig-details/'.$allrecord->slug)}}" class="amount_list">${{$allrecord->gig_fixed_price}}</a>
                                                   @endif
                                                </div>
                                            </div>                                            
                                        </div>
                                        ...
                                        <div class="client-rv">
                                            ...
                                            <div class="client-review-reting" >
                                                <div style="display:flex; flex-direction:row; align-items:center !important; justify-content:center !important; ">
                                                    <!--<gig-rating :rate="{{ $allrecord->rating }}"></gig-rating>-->
