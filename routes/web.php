...
Route::post('/users/updateAccount', 'UsersController@updateAccount')->name('update.account');
Route::post('/users/updatePaypal', 'UsersController@updatePaypal')->name('update.paypal');
Route::post('/users/updatePayoneer', 'UsersController@updatePayoneer')->name('update.payoneer');
Route::post('/users/updateBank', 'UsersController@updateBank')->name('update.bank');
...
Route::any('/payments/paywithpaypal/{slug}', 'PaymentsController@createPaypalPayment');
Route::get('/payments/executePaypal', 'PaymentsController@executePaypal');
...
Route::any('/users/messageuser', 'UsersController@messageuser')->middleware('auth');
Route::any('/messages/message/{slug}', 'MessagesController@message');
Route::get('/contacts', 'MessagesController@contacts'); 

Route::any('/messages/message', 'MessagesController@message')->middleware('auth');
Route::get('/messages/{id}', 'MessagesController@getMessages')->middleware('auth');
Route::post('/messages/send/{id}', 'MessagesController@sendMessage')->middleware('auth');
Route::post('/messages/send/{id}', 'MessagesController@sendMessage')->middleware('auth');
Route::get('/message/getUnreadCount', 'MessagesController@getUnreadCount')->middleware('auth');
Route::get('/deleteConvo/{id}', 'MessagesController@deleteMessages')->middleware('auth');
