    ...
    <section class="dashboard-section">
        ...
        <div class="workplace">
            ...
            <div class="req_dtl">
                ...
                <div class="req_row">
                    <label>Title: </label> <span><?php echo e($myorderInfo->Gig->title); ?></span>
                    <div class="req_post"><label>Posted: </label> <?php echo e($myorderInfo->Gig->created_at->format('M d, Y')); ?></div>
                </div>
                    ...
                    <?php if($myorderInfo->buyer_id == Session::get('user_id')): ?>
                        ...
                        <div class="dpimg-about_right">
                            <div class="buy_row">
                                ...
                                <div class="buy_name">
                                    <span><a href="<?php echo e(URL::to( 'public-profile/'.$myorderInfo->Seller->slug)); ?>"><?php echo e($myorderInfo->Seller->user_name); ?></a></span>
                       ...
                       <div class="req_dtl_head">About the Buyer</div>
                        <div class="dpimg-about_right">
                            <div class="buy_row">
                                ...
                                <div class="buy_name">
                                    <span><a href="<?php echo e(URL::to( 'public-profile/'.$myorderInfo->Buyer->slug)); ?>"><?php echo e($myorderInfo->Buyer->user_name); ?></a></span>
                                    <div class="about-rating">
                                        <script>
                                            $(function() {
                                                $('#avgRating222').raty({
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seenshop/laravel.seenshop.com/resources/views/myorders/ratebuyer.blade.php ENDPATH**/ ?>