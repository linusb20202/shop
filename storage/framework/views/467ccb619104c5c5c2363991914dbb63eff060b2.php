...
<html>
    <head>
        ...
        <!--<script type="text/javascript" src="<?php echo e(url(config('app.url'))); ?>/public/js/jquery.validate.js", defer></script>-->
        ...
        <?php echo e(HTML::script('public/js/jquery-2.1.0.min.js'), 'defer'); ?>
...
</html><?php /**PATH /home/seenshop/laravel.seenshop.com/resources/views/layouts/inner.blade.php ENDPATH**/ ?>