    ...
    <div class="panel-body marginzero">
        ...
        <?php echo e(Form::open(array('method' => 'post', 'id' => 'actionFrom'))); ?>
            ...
            <section id="no-more-tables" class="lstng-section">
                <div class="topn">
                    <div class="topn_left">Wallets List</div>
                        ...
                        <?php $__currentLoopData = $allrecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td data-title="Action">
                                    <?php if($allrecord->status == 0): ?>
                                    <a href="<?php echo e(URL::to( 'admin/wallets/approve-reject/accept/'.$allrecord->slug)); ?>" title="Approve" class="deactivate"  onclick="return confirm('Are you sure you want to delete this record?')"><span class="btn btn-success btn-xs"><i class="fa fa-check"></i></span></a>
                                    <a href="<?php echo e(URL::to( 'admin/wallets/approve-reject/reject/'.$allrecord->slug)); ?>" title="Reject" class="activate"  onclick="return confirm('Are you sure you want to delete this record?')"><span class="btn btn-danger btn-xs"><i class="fa fa-ban"></i></span></a>
                                    <?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/seenshop/laravel.seenshop.com/resources/views/elements/admin/wallets/index.blade.php ENDPATH**/ ?>