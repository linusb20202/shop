                    ...
                    <div class="about_seller">
                        ...
                        <div class="profile-about">
                            ...
                            <div class="dp_details-about">
                                <h3><a href="<?php echo e(URL::to( 'public-profile/'.$recordInfo->User->slug)); ?>"><?php echo e($recordInfo->User->user_name ? $recordInfo->User->user_name : ''); ?> </a></h3>
                                <p><?php echo e($recordInfo->User->address); ?></p>
                                <div class="about-rating">
                                    
                                    <span class="req_rate"><i class="fa fa-star starred"></i><b><?php echo e($recordInfo->User->average_rating); ?></b> (<?php echo e($recordInfo->User->total_review); ?> reviews)</span>
                                </div>
                        ...
                        <div class="send-form">
                            ...
                            <?php if($recordInfo->status == 1): ?>
                                ...
                                <div class="form-group offer_field">
                                    ...
                                    <div class="send_input">
                                    <?php echo e(Form::text('deliver_in', null, ['class'=>'form-control required digits', 'placeholder'=>'days', 'autocomplete' => 'off'])); ?>
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seenshop/laravelvue.seenshop.com/resources/views/services/detail.blade.php ENDPATH**/ ?>