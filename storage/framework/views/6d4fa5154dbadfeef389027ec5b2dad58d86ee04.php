    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="admin_search">
                ...
                <div class="add_new_record"><a href="<?php echo e(URL::to('admin/users/add')); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Add User</a></div>
            </div>            
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seenshop/laravel.seenshop.com/resources/views/admin/users/index.blade.php ENDPATH**/ ?>