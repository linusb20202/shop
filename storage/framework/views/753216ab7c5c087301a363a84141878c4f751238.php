                    ...
                    <div class="management-table">
                        ...
                        <?php $__currentLoopData = $allrecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="management-table-tr">
                                ...
                                <div class="management-table-td"><?php echo e($allrecord->Seller->first_name.' '.$allrecord->Seller->last_name); ?></div>
                                ...
                                <div class="management-table-td">
                                    ...
                                    <?php if($allrecord->status == 2 && $allrecord->is_buyer_rate != 1): ?>
...
<div id="info<?php echo $allrecord->id; ?>" style="display: none;" class="frnt_div">
    <div class="nzwh-wrapper">
        <fieldset class="nzwh">
            ...
            <div class="drt">
                <div class="admin_pop"><span>Seller Name: </span>  <label><?php echo $allrecord->Seller->first_name.' '.$allrecord->Seller->last_name; ?></label></div>
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jaimebalatero/Desktop/prozed/laravelvue/09-14-20/resources/views/myorders/buyingorders.blade.php ENDPATH**/ ?>