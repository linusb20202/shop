...
<div class="main_dashboard">
    ...
    <div class="login_section" id="app">
        <div class="container">
            <div class="row">
            ...
            <div class="col-sx-12 col-sm-8 col-md-9">
             <div class="latest-bxs">
                    
                       <carousel-home></carousel-home> 
                       <!--<gig-images></gig-images>-->
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seenshop/laravelvue.seenshop.com/resources/views/homes/loginindex.blade.php ENDPATH**/ ?>