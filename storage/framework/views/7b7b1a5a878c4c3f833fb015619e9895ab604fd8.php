                ...
                <?php if(!$allrecords->isEmpty()): ?>
                    ...
                    <div class="col-sm-5 col-md-3 buycnt">
                        <div class="profile-bx">
                            ...
                            <h2><?php echo isset($allrecord->Buyer->user_name)?$allrecord->Buyer->user_name : ''; ?></h2>
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seenshop/laravelvue.seenshop.com/resources/views/users/buyercontacts.blade.php ENDPATH**/ ?>