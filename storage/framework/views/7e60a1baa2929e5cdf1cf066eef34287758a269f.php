                                ...
                                <div class="management-bx-over">
                                    <div class="management-table">
                                        ...
                                        <div class="management-table-tr">
                                            ...
                                            <div class="management-table-td"><?php echo e($allrecord->Buyer->user_name); ?></div>
                                            <div class="management-table-td"><?php echo str_limit($allrecord->Gig->title, $limit = 20, $end = ' ...'); ?></div>
                                            <div class="management-table-td"><?php echo e(ucfirst($allrecord->package)); ?></div>
                                ...
                                <div id="info<?php echo $allrecord->id; ?>" style="display: none;" class="frnt_div">
                                    <div class="nzwh-wrapper">
                                        <fieldset class="nzwh">
                                            ...
                                            <div class="drt">
                                                <div class="admin_pop"><span>Buyer Name: </span>  <label><?php echo $allrecord->Buyer->user_name; ?></label></div>
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seenshop/laravelvue.seenshop.com/resources/views/users/dashboard.blade.php ENDPATH**/ ?>