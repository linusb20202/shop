            ...
            <div class="row">
                <div class="col-xs-12 col-md-8">
                    ...
                    <div class="summary">
                        <div class="gig-summary">
                            <div class="gig-summary-img">
                                <a href="#" class="gig-picture-link">
                                    ...
                                    ?>
                                    <?php echo e(HTML::image($gigimgname, SITE_TITLE,['title'=>$recordInfo->title])); ?>

                                </a>
                            </div>
                            <div class="gig-summary-details">
                                <h3>
                                    <a href="<?php echo e(URL::to( 'gig-details/'.$recordInfo->Gig->slug)); ?>">
                                        <?php echo e($recordInfo->Gig->title); ?>
                        ...
                        <div class="pricing">
                            ...
                            <span class="price"><b><?php echo e(CURR.number_format($recordInfo->amount, 2)); ?></b></span>
                        </div>
                    </div>
                    <div class="package">
                        <h3><?php echo e(ucfirst($recordInfo->package)); ?>: 
                        <p>
                            <?php
                        ...
                        <ul class="checklist">
                            <li>
                                <span> 
                                    ...
                                    if($recordInfo->package != 'fixed'){
                                        echo $recordInfo->Gig->$ddtitle;
                                    } else {
                                        echo $recordInfo->Gig->gig_fixed_delivery;
                                    }
                                ...
                                <span> 
                                    ...
                                    $ddtitle = $recordInfo->package . '_revision';
                                     if($recordInfo->package != 'fixed'){
                                        ...
                                        echo $recordInfo->Gig->gig_fixed_revision;
                                    }
                                    ?> 
                                    Revision
                                </span>
                        ...
                        <div class="ors">
                            <?php echo nl2br($recordInfo->Gig->description); ?>
                ...
                <div class=" col-xs-12 col-md-4 sticky">
                    <div class="offer_wrap ">
                        ...
                        <div class="send-form"> 
                            <div class="summery-dtl">
                                ...
                                <span><?php echo e(CURR.$recordInfo->amount); ?></span>
                            </div>
                            <div class="summery-dtl">
                                <label>Service Fee</label>
                                <span><?php echo e(CURR.number_format($recordInfo->admin_amount, 2)); ?></span>
                            </div>
                            <div class="summery-dtl summery-totl">
                                <label>Total</label>
                                <span><?php echo e(CURR.number_format($recordInfo->total_amount, 2)); ?></span>
                            </div>
                            <div class="summery-dtl" id="btndive">
                                ...
                                <?php if($amountArray['availableforwithdraw'] >= $recordInfo->total_amount): ?>
                            ...
                            <div class="paywithcard" id="paywithpaypal">
                                ...
                                <?php echo e(Form::hidden('slug', $recordInfo->slug, [])); ?>                                
                                <div class="summery-dtl summery-totl">
                                    <label>Order Amount</label>
                                    <span><?php echo e(CURR.number_format($recordInfo->total_amount, 2)); ?></span>
                                </div>
                                <div class="pay-btn" id="btndivetallet">
                                    <a href="<?php echo e(URL::to( 'payments/paywithpaypal/'.$recordInfo->slug)); ?>" class="btn btn-primary">Pay now</a>
                                    <!--<?php echo e(Form::submit('Pay now', ['class' => 'btn btn-primary'])); ?>-->
                            ...
                            <div class="paywithcard" id="paywithwallet">
                                ...
                                <div class="summery-dtl summery-totl">
                                    ...
                                    <span><?php echo e(CURR.number_format(($amountArray['availableforwithdraw'] - $recordInfo->total_amount), 2)); ?></span>
                                </div>
                                <div class="pay-btn" id="btndivetallet">
                    ...
                    <div class="buyer-protection">
                        <ul>
                            <li>
                                <i class="note-icon fa fa-lock " style="color:#5CB85C;"> </i>
                                <span>
                            ...
                            <li>
                                <i class="note-icon fa fa-check-circle" style="color:#5CB85C;"></i>
                                <span>
                            ...
                            <li>
                                <i class="note-icon fa fa-user" style="color:#5CB85C;"></i>
                                <span>
...
<script>
    function paywithcard() {
      if (cardFormValidate()) {
            ...
            $.ajax({
                url: "/payments/paywithcard",
                type: "POST",
                data: $('#paymentForm').serialize(),
                success: function (result) {
                    if(result == 1){
                        window.location = "/buying-orders";
                    }else{
                        $('#gigdloader').hide();
                        $('#btndivecard').show();
    ...
    function payviawallet() {
        if (confirm('Please do not refresh or click borwser back button.') == true) {
            ...
            $('#gigdloader').show();
            $.ajax({
                url: "/payments/payviawallet",
                type: "POST",
                data: {'slug': '<?php echo $recordInfo->slug; ?>', _token: '<?php echo e(csrf_token()); ?>'},
                success: function (result) {
                    window.location = "/buying-orders";
                }
            });
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seenshop/laravelvue.seenshop.com/resources/views/payments/ordersummary.blade.php ENDPATH**/ ?>