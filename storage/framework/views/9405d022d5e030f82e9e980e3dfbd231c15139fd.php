...
<header class="header">
    ...
    <div class="wrapper">
        <div class="header_inner">
            <div class="logo"><a href="/"> <?php echo e(HTML::image(LOGO_PATH, SITE_TITLE)); ?></a></div>
                    ...
                    <ul>
                        ...
                        <li class="left notification-b" >
                            ...
                            <ul class="notification displaynonenot" id="msgcontaine">
                             ...
                             <indicator :user="<?php echo e(auth()->user()); ?>"></indicator>
...
</script><?php /**PATH /home/seenshop/laravelvue.seenshop.com/resources/views/elements/header.blade.php ENDPATH**/ ?>