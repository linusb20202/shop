                    ...
                    <div class="management-table">
                        ...
                        <?php $__currentLoopData = $allrecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="management-table-tr">
                                ...
                                <div class="management-table-td"><?php echo e($allrecord->Gig->User->user_name); ?></div>
                                <div class="management-table-td"><?php echo str_limit($allrecord->Gig->title, $limit = 30, $end = ' ...'); ?></div>
...
<div id="info<?php echo $allrecord->id; ?>" style="display: none;" class="frnt_div">
    <div class="nzwh-wrapper">
        <fieldset class="nzwh">
            ...
            <div class="drt">
                <div class="admin_pop"><span>Seller Name: </span>  <label><?php echo $allrecord->Gig->User->user_name; ?></label></div>
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seenshop/laravelvue.seenshop.com/resources/views/myorders/buyingorders.blade.php ENDPATH**/ ?>