            ...
            <div class="row">
                <div class="col-sm-5 col-md-4">
                    <div class="profile-bx">
                        ...
                        <h2><?php if(isset($recordInfo->user_name)): ?>
                        ...
                        <p id="contactn" class="showall"> <span id="showcontact"> <?php echo $recordInfo->contact; ?> </span> <span class="curpointer" onclick="showeditdiv('contactn');"><i class="fa fa-pencil" aria-hidden="true"></i></span></p>
                        ...
                        <div class="user-details">
                            ...
                            <div class=" displaynone" id="div_countryctn">
                                ...
                                <div class="educss">
                                    ...
                                    <div class="lan_field"> <?php echo e(Form::text('zipcode', $recordInfo->zipcode, ['class'=>'form-control required', 'placeholder'=>'Zipcode', 'autocomplete' => 'off', 'id'=>'zipcode_id', 'maxlength'=>10])); ?></div>
                                </div>
                                ...
                                <div class="management-bx-over">
                                    <div class="management-table">
                                        ...
                                        <div class="management-table-tr">
                                            ...
                                            <div class="management-table-td"><?php echo e($allrecord->Buyer->first_name.' '.$allrecord->Buyer->last_name); ?></div>
                                            <div class="management-table-td"><?php echo e($allrecord->Gig->title or ''); ?></div>
                                ...
                                <div id="info<?php echo $allrecord->id; ?>" style="display: none;" class="frnt_div">
                                    <div class="nzwh-wrapper">
                                        <fieldset class="nzwh">
                                            ...
                                            <div class="drt">
                                                <div class="admin_pop"><span>Buyer Name: </span>  <label><?php echo $allrecord->Buyer->first_name.' '.$allrecord->Buyer->last_name; ?></label></div>
                                                <div class="admin_pop"><span>Gig Title: </span>  <label><?php echo e($allrecord->Gig->title or ''); ?></label></div>
                                        ...
                                        <div class="management-table-tr">
                                            ...
                                            <div class="management-table-td">
                                                <div class="buyer-img">
                                                    ...
                                                    <?php else: ?>
                                                    <a href="<?php echo e(URL::to('public-profile/'.$allrecord->User->slug)); ?>" class=""><?php echo e(HTML::image('./img/front/user-img.png', SITE_TITLE,['style'=>"max-width: 60px"])); ?></a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jaimebalatero/Desktop/prozed/laravelvue/09-14-20/resources/views/users/dashboard.blade.php ENDPATH**/ ?>