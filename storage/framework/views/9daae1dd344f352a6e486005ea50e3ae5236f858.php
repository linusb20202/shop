        ...
        <div class="container">
            ...
            <div class="col-sx-12 col-sm-4 col-md-3">
                <div class="user-box-login">
                    <h3 class="">Hi, <?php echo e($loginuser->user_name); ?></h3>
             ...
             <div class="latest-bx">
                    <div id="pay_slider2" class="owl-carousel">
                        <div class="home-banners">
                            <div class="thumbnail">
                                <a href="javascript:void()">
                                 <?php echo e(HTML::image('public/img/front/banner-home.jpg', SITE_TITLE)); ?>
                        ...
                        <div class="home-banners">
                            <div class="thumbnail">
                                <a href="javascript:void()">
                                    <?php echo e(HTML::image('public/img/front/banner-home2.jpg', SITE_TITLE)); ?>
                    ...
                    <div class="rec_block">
                        <div class="rec_block_inner">
                            ...
                            <div class="img_con_btm_bx">
                                <div class="img_con"><?php echo e($allrecord->Gig->title or ''); ?></div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jaimebalatero/Desktop/prozed/laravelvue/09-14-20/resources/views/homes/loginindex.blade.php ENDPATH**/ ?>