                                    ...
                                    <div class="buy_name">
                                        ...
                                        <div class="about-rating">
                                             <div style="display:flex; flex-direction:row; text-align:left !important; margin-top:10px; ">
                                                <gig-rating :rate="<?php echo e($orderInfo->Buyer->average_rating); ?>"></gig-rating>
                                                <span style="font-size:14px;"> <b> <?php echo e($orderInfo->Buyer->average_rating); ?></b> (<?php echo e($orderInfo->Buyer->total_review); ?> Reviews)</span>
                                            </div>    
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seenshop/laravelvue.seenshop.com/resources/views/myorders/workplace.blade.php ENDPATH**/ ?>