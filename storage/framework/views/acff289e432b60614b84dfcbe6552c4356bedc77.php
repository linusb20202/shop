...
<script>
    ...
    var x = '<?php if(count($recordCustInfo)) {  echo count($recordCustInfo); } else {  echo 0; } ?>'
    ...
    $(addButton).click(function(){
        ...
        if(x < maxField){ 
            ...
            // $(wrapper).append('<tr id="row'+x+'" ><td style="padding:10px !important; padding-right:15px !important;"><input type="text" name="fieldname[]" id="fieldname'+x+'" required placeholder="Enter field name" class="form-control name_list" /><a class="delete-btn remove_button" id="'+x+'"" href="javascript:void(0)" ><i class="fa fa-trash"></i></a></td><td class="price_tooltip" style="text-align:center !important;"> <input type="checkbox"  name="1check[]" ></td><td  class="price_tooltip" class="text-center" style="text-align:center !important;"><input type="checkbox"  name="2check[]" ></td><td  class="price_tooltip" style="text-align:center !important;"><input type="checkbox"  name="3check[]" ></td></tr>');
            $(wrapper).append('<tr id="row'+x+'" ><td  style="padding:10px !important; background:#fafafa !important; padding-right:15px !important;"><input type="text" name="fieldname'+x+'" id="fieldname'+x+'" required placeholder="Enter field name" class="form-control name_list" /><a class="delete-btn remove_button" id="'+x+'"" href="javascript:void(0)" ><i class="fa fa-trash"></i></a></td><td class="price_tooltip" style="text-align:center !important;"> <input type="checkbox"  name="1check'+x+'" ></td><td  class="price_tooltip" class="text-center" style="text-align:center !important;"><input type="checkbox"  name="2check'+x+'" ></td><td  class="price_tooltip" style="text-align:center !important;"><input type="checkbox"  name="3check'+x+'" ></td></tr>');
        }
    });
    ...
    //Insert fields on Gig Fixed Price
    $(document).ready(function(){
    ...
    $(addButton2).click(function(){
        ...
        if(x < maxField2){ 
            ...
            // $(wrapper).append(fieldHTML); //Add field html
            // $(wrapper).append('<tr id="row'+x+'" ><td style="padding:10px !important; padding-right:15px !important;"><input type="text" name="fieldname[]" id="fieldname'+x+'" required placeholder="Enter field name" class="form-control name_list" /><a class="delete-btn remove_button" id="'+x+'"" href="javascript:void(0)" ><i class="fa fa-trash"></i></a></td><td class="price_tooltip" style="text-align:center !important;"> <input type="checkbox"  name="1check[]" ></td><td  class="price_tooltip" class="text-center" style="text-align:center !important;"><input type="checkbox"  name="2check[]" ></td><td  class="price_tooltip" style="text-align:center !important;"><input type="checkbox"  name="3check[]" ></td></tr>');
            $(wrapper2).append('<tr id="fixed_row'+x+'" style="margin-top:10px;"><td  style="padding:10px !important; background:#fafafa !important; padding-right:15px !important;"><input type="text" name="fieldname'+x+'" id="fixed_fieldname'+x+'" required placeholder="Enter field name" class="form-control name_list" /><a style="margin-top:8px !important;" class="delete-btn remove_button" id="'+x+'"" href="javascript:void(0)" ><i class="fa fa-trash"></i></a></td><td class="price_tooltip" style="text-align:center !important;"> <input type="checkbox"  name="1check'+x+'" ></td></tr>');
        }
    });
    ...
    // $(document).on('click', '.btn_remove', function()
        ...
        var button_id = $(this).attr("id");
        $('#fixed_row'+button_id+'').remove();  
        // $(this).parent('div').remove(); //Remove field html
        x--; //Decrement field counter
    });
    });
    // Gig Fixed Price Insert fields End
        ...
        function readURL(input) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    ...
                    $('#ShowImage1_div').addClass('hide_img_add');
                    $('.close_btn1').show();
                }
        ...
        function readURL1(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    ...
                    $('#ShowImage2_div').addClass('hide_img_add');
                    $('.close_btn2').show();
                }
        ...
        function readURL2(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    ...
                    $('#ShowImage3_div').addClass('hide_img_add');
                    $('.close_btn3').show();
                }
        ...
        function readURL3(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    ...
                    $('#ShowImage4_div').addClass('hide_img_add');
                    $('.close_btn4').show();
                }
...
//                    $('#ShowPdf3').attr('src', e.target.result);
        ...
        $(".close_btn1").on("click", function () {
            var img = $('#ShowImage1').attr('src');
            if (img) {
                $('#ShowImage1').attr('src','<?php echo HTTP_PATH.'/public/img/front/no_image.png' ?>');
            }
            $('.close_btn1').hide();
            $('#ShowImage1_div').removeClass('hide_img_add');
        });
        $(".close_btn2").on("click", function () {
            var img = $('#ShowImage2').attr('src');
            if (img) {
                $('#ShowImage2').attr('src','<?php echo HTTP_PATH.'/public/img/front/no_image.png' ?>');
            }
            $('.close_btn2').hide();
            $('#ShowImage2_div').removeClass('hide_img_add');
        });
        $(".close_btn3").on("click", function () {
            var img = $('#ShowImage3').attr('src');
            if (img) {
                $('#ShowImage3').attr('src','<?php echo HTTP_PATH.'/public/img/front/no_image.png' ?>');
            }
            $('.close_btn3').hide();
            $('#ShowImage3_div').removeClass('hide_img_add');
        });
        $(".close_btn4").on("click", function () {
            var img = $('#ShowImage4').attr('src');
            if (img) {
                $('#ShowImage4').attr('src','<?php echo HTTP_PATH.'/public/img/front/no_image.png' ?>');
            }
            $('.close_btn4').hide();
            $('#ShowImage4_div').removeClass('hide_img_add');
        });
    });
...
<script>
    function addFaq() {
        ...
        faqnav += '<input name="question[]" id="faqques_' + newItem + '" minlength="5" maxlength="80" class="form-control faqques required valid" placeholder="Add a Question: i.e. Do you translate to English as well?" type="text">';
        faqnav += '<textarea name="answer[]" id="faqans_' + newItem + '" minlength="5" maxlength="300" class="form-control faqans texta required valid" placeholder="Add an Answer: i.e. Yes, I also translate from English to Hebrew." cols="30" rows="6"></textarea>';
        ...
        faqnav += '<input type="button" id="faqcan_' + newItem + '" class="btn-standard btn-green-grad btn-cancel-faq" value="Cancel" onclick="deletefaq(' + newItem + ')">';
        faqnav += '<input type="button" id="faqsub_' + newItem + '" class="btn-standard btn-white-grad btn-add-faq" value="add" onclick="submitfaq(' + newItem + ')">';
        faqnav += '</div>';
        faqnav += '</div>';
        $(".action-faq").hide();
    ...
    function submitfaq(idval) {
        ...
        if ($("#gigform").valid()) {
            ...
            view_faq_frame += '<input name="question[]" id="faqques_' + idval + '" minlength="5" maxlength="80" class="form-control faqques required valid" placeholder="Add a Question: i.e. Do you translate to English as well?" type="text" value="' + faqquesval + '">';
            view_faq_frame += '<textarea name="answer[]" id="faqans_' + idval + '" minlength="5" maxlength="300" class="form-control faqans texta required valid" placeholder="Add an Answer: i.e. Yes, I also translate from English to Hebrew." cols="30" rows="6">' + faqansval + '</textarea>';
            ...
            view_faq_frame += '<input type="button" id="faqcan_' + idval + '" class="btn-standard btn-green-grad btn-cancel-faq" value="Cancel" onclick="cancelfaq(' + idval + ')">';
            view_faq_frame += '<input type="button" id="faqsub_' + idval + '" class="btn-standard btn-white-grad btn-add-faq" value="update" onclick="updatefaq(' + idval + ')">'
            view_faq_frame += '</div>';
...
//            $("#faq_view_nav_" + idval).remove();
    ...
    function deleteextra(idval) {
        if ($("#extra_box_" + idval).length > 0) {
            $("#extra_box_" + idval).remove();
        }
    }
            ...
            submitHandler: function (form) {
                ...
                if (isdocupload == '1') {
                    ...
                    if (step == 1) {
                        $.ajax({
                            type: 'POST',
                            url: "/gigs/edit/<?php echo $gigDetail->slug; ?>",
    ...
    <section class="dashboard-section">
        <div class="container">
            <div class="row">
                ...
                <div class="gig_from">
                    <?php echo e(Form::model($gigDetail, ['method' => 'post', 'name' => 'gigform', 'id' => 'gigform', 'enctype' => "multipart/form-data"])); ?> 
                        ...
                        <div class="step_form_inner step_account1" id="gig_overview">
                            <div class="form_field">
                                ...
                                <div class="right_filed">
                                    <div class="text_area">
                                        <?php echo e(Form::textarea('title', null, ['minlength' => 5, 'maxlength' => 80, 'class'=>'form-control required', 'placeholder'=>"Do something i'm really good at", 'autocomplete' => 'off', 'rows'=>4])); ?>
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <?php echo e(Form::submit('Save &amp; Continue', ['class' => 'btn btn-info', 'id'=>'step_2'])); ?>

                                <div class="gig_loader"  style="display: none;" id="loaderID"><?php echo e(HTML::image("public/img/loading.gif", SITE_TITLE)); ?></div>
                            </div>
                        </div>
                        <div class="step_form_inner second_page step_account2" id="gig_package">
                            <div class="row">
                                <div class="col-sm-6 md-6"><h3 id="heading">Packages</h3></div>
                                <div class="col-sm-6 md-6">
                                    
                                 <!--   <div class="btn-group btn-toggle"> -->
                                 <!--       <button class="btn btn-xs btn-light" style="color:#EFEFEF; text-decoration:none;" tag="span">NO</button>-->
                                 <!--   	<button class="btn btn-xs btn-success active" style="color:#EFEFEF;  text-decoration:none; tag="span">YES</button>-->
                                	<!--</div>-->
                                	<!-- Rounded switch -->
                                    <div class="material-switch pull-right" >
                                        <span style="margin-right:5px;">Fixed Price : </span> <input id="someSwitchOptionSuccess"  type="checkbox" <?php if($gigDetail->gig_fixed_price != null) { ?> checked <?php } ?>   value="0" onclick="myFunction()"  />
                                        <label for="someSwitchOptionSuccess" class="label-success"></label>
                                    </div>
                                </div>
                            </div>
                            <div class="row"><hr style="margin-right:10px; margin-left:10px;"/></div>
                            <div class="row"  id="fixed" <?php if($gigDetail->gig_fixed_price != null) { ?> style="display:block;" <?php } else { ?> style="display:none;" <?php } ?> >
                                 <div class="col-sm-2 md-2"> </div>
                                  <div class="col-sm-8 md-8">
                                        <div class="form-group row proposal-price justify-content-center">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <?php global $package_price; ?>
                                                    <?php echo e(Form::select('gig_fixed_price', $package_price,null, ['class' => 'form-control arrowed required','placeholder' => 'Select Price', 'id' => 'gig_fixed_price'])); ?>
                                        ...
                                        <div class="form-group row proposal-price justify-content-center mb-4"><!--- form-group row Starts --->
                                            ...
                                            <label>Gig Revisions</label>
                                            <?php global $revisions; ?>
                                                    <?php echo e(Form::select('gig_fixed_revision', $revisions,null, ['class' => 'form-control arrowed required','placeholder' => 'Select', 'id' => 'gig_fixed_revision'])); ?>   
                                        ...
                                        <div class="form-group row proposal-price justify-content-center mb-4"><!--- form-group row Starts --->
                                            ...
                                            <?php global $delivery_days; ?>
                                                    <?php echo e(Form::select('gig_fixed_delivery', $delivery_days,null, ['class' => 'form-control arrowed required','placeholder' => 'Delivery Time', 'id' => 'gig_fixed_del'])); ?>
                                        ...
                                        <div class="row">
                                            <div class="table-container" style="overflow:hidden" >
                                                ...
                                                <tbody class="field_wrapper2" >
                                                     <?php
                                                    if(count($recordCustInfo) > 0 && ($gigDetail->gig_fixed_price != null)) {
                                                        $custnum1 = 0;
                                                        foreach($recordCustInfo as $custInfo1){ $custnum1 = $custnum1 + 1; ?>
                                                            <tr id="fixed_row<?php echo $custnum1; ?>" ><td style="padding:10px !important; background:#fafafa !important; padding-right:15px !important;"><input type="text" name="fieldname<?php echo $custnum1; ?>" id="fixed_fieldname<?php echo $custnum1; ?>" value="<?php echo $custInfo1->fieldname;  ?>" required placeholder="Enter field name" class="form-control name_list" /><a style="margin-top:8px !important;" class="delete-btn remove_button" id="<?php echo $custnum1; ?>" href="javascript:void(0)" ><i class="fa fa-trash"></i></a></td><td class="price_tooltip" style="text-align:center !important;"> <input type="checkbox"  name="1check<?php echo $custnum1; ?>" <?php if($custInfo1->check1 == 1) echo'checked'; ?> ></td></tr>
                                                     <?php   }
                                        ...
                                        <div class="row" id="addField2" style="">
                                  
                                            <div class="another ">
                                                <a href="javascript:void(0)" style=" text-decoration:none;" class="add_button2" ><b>+</b> Add New Custom Field</a>
                                            </div>
                            ...
                            <div class="row" id="standard" <?php if($gigDetail->gig_fixed_price == null) { ?> style="display:block;" <?php } else { ?> style="display:none;" <?php } ?>>
                                <div class="col-sm-12">
                                    <div class="table-container" style="overflow:hidden" >
                                <table cellspacing="0" style=" border-collapse:  collapse; border-spacing:   0;">
                                    <thead>
                                        <tr>
                                            <th> </th>
                                            <th class="shown" style="font-weight: bold; text-align:center; border-right: 1px solid #ddd !important;">
                                                Basic
                                            </th>
                                            <th class="shown" style="font-weight: bold; text-align:center; border-right: 1px solid #ddd !important;">
                                                Standard
                                            </th>
                                            <th class="shown" style="font-weight: bold; text-align:center;">
                                                Premium
                                            </th>
                                        </tr>
                                    </thead>   
                                    <tbody class="field_wrapper">
                                        <tr>
                                            <th style="background:#fafafa !important;">Title</th>
                                            <td class="package_tool tool_first">
                                                
                                                <?php echo e(Form::textarea('basic_title', null, ['minlength' => 5, 'maxlength' => 35, 'class'=>'required', 'placeholder'=>"Name your package"])); ?>
                                            ...
                                            <td class="package_tool tool_sec">
                                                <?php echo e(Form::textarea('standard_title', null, ['minlength' => 5, 'maxlength' => 35, 'class'=>'required', 'placeholder'=>"Name your package"])); ?>
                                            ...
                                            <td  class="package_tool tool_third">
                                                <?php echo e(Form::textarea('premium_title', null, ['minlength' => 5, 'maxlength' => 35, 'class'=>'required', 'placeholder'=>"Name your package"])); ?>
                                        ...
                                        <tr>
                                            <th style="background:#fafafa !important;">Description</th>
                                            <td class="description_tool desc_one">
                                                <?php echo e(Form::textarea('basic_description', null, ['minlength' => 5, 'maxlength' => 100, 'class'=>'required', 'placeholder'=>"Description"])); ?>
                                            ...
                                            <td class="description_tool desc_sec">
                                                <?php echo e(Form::textarea('standard_description', null, ['minlength' => 5, 'maxlength' => 100, 'class'=>'required', 'placeholder'=>"Description"])); ?>
                                            ...
                                            <td class="description_tool desc_thir">
                                                <?php echo e(Form::textarea('premium_description', null, ['minlength' => 5, 'maxlength' => 100, 'class'=>'required', 'placeholder'=>"Description"])); ?>
                                        ...
                                        <tr>
                                            <th style="background:#fafafa !important;">Delivery Time</th>
                                            <td class="deliverytool deli_first">
                                                <span class="drop_arow">
                                                    <?php global $delivery_days; ?>
                                                    <?php echo e(Form::select('basic_delivery', $delivery_days,null, ['class' => 'required','placeholder' => 'Delivery Time'])); ?>
                                            ...
                                            <td class="deliverytool deli_sec"> 
                                                <span class="drop_arow">
                                                    <?php echo e(Form::select('standard_delivery', $delivery_days,null, ['class' => 'required','placeholder' => 'Delivery Time'])); ?>
                                            ...
                                            <td class="deliverytool deli_thiir">
                                                <span class="drop_arow">
                                                    <?php echo e(Form::select('premium_delivery', $delivery_days,null, ['class' => 'required','placeholder' => 'Delivery Time'])); ?>
                                        ...
                                        <tr>
                                            <th style="background:#fafafa !important;">Revision</th>
                                            <td>
                                                <span class="drop_arow">
                                                    <?php global $revisions; ?>
                                                    <?php echo e(Form::select('basic_revision', $revisions,null, ['class' => 'required','placeholder' => 'Select'])); ?>                                           
                                                </span>
                                                <div class="delivery_tooltip">
                                                    <div class="fake-hint blue">
                                                        <div class="icn">
                                            ...
                                            <td>
                                                <span class="drop_arow">
                                                    <?php echo e(Form::select('standard_revision', $revisions,null, ['class' => 'required','placeholder' => 'Select'])); ?>                                           
                                                </span>
                                                <div class="delivery_tooltip">
                                                    <div class="fake-hint blue">
                                                        <div class="icn">
                                            ...
                                            <td>
                                                <span class="drop_arow">
                                                    <?php echo e(Form::select('premium_revision', $revisions,null, ['class' => 'required','placeholder' => 'Select'])); ?>                                           
                                                </span>
                                                <div class="delivery_tooltip">
                                                    <div class="fake-hint blue">
                                                        <div class="icn">
                                        ...
                                        <tr>
                                            <th style="background:#fafafa !important;">Price</th>
                                            <td class="price_tooltip first_rate">
                                                <span class="drop_arow">
                                                    <?php global $package_price; ?>
                                                    <?php echo e(Form::select('basic_price', $package_price,null, ['class' => 'required','placeholder' => 'Select Price'])); ?>
                                            ...
                                            <td class="price_tooltip second_rate">
                                                <span class="drop_arow">
                                                    <?php echo e(Form::select('standard_price', $package_price,null, ['class' => 'required','placeholder' => 'Select Price'])); ?>
                                            ...
                                            <td class="price_tooltip third_rate">
                                                <span class="drop_arow">
                                                    <?php echo e(Form::select('premium_price', $package_price,null, ['class' => 'required','placeholder' => 'Select Price'])); ?>
                                        ...
                                        if(count($recordCustInfo) > 0 && ($gigDetail->gig_fixed_price == null)) {
                                            $custnum = 0;
                                            foreach($recordCustInfo as $custInfo){ $custnum = $custnum + 1; ?>
                                                <tr id="row<?php echo $custnum; ?>" ><td style="padding:10px !important; background:#fafafa !important; padding-right:15px !important;"><input type="text" name="fieldname<?php echo $custnum; ?>" id="fieldname<?php echo $custnum; ?>" value="<?php echo $custInfo->fieldname; ?>" required placeholder="Enter field name" class="form-control name_list" /><a class="delete-btn remove_button" id="<?php echo $custnum; ?>" href="javascript:void(0)" ><i class="fa fa-trash"></i></a></td><td class="price_tooltip" style="text-align:center !important;"> <input type="checkbox"  name="1check<?php echo $custnum; ?>" <?php if($custInfo->check1 == 1) echo'checked'; ?> ></td><td  class="price_tooltip" class="text-center" style="text-align:center !important;"><input type="checkbox"  name="2check<?php echo $custnum; ?>" <?php if($custInfo->check2 == 1) echo'checked'; ?> ></td><td  class="price_tooltip" style="text-align:center !important;"><input type="checkbox"  name="3check<?php echo $custnum; ?>" <?php if($custInfo->check3 == 1) echo'checked'; ?> ></td></tr>
                                         <?php   }
                                ...
                                <div class="row" id="addField" style="margin-left:11px;">
                                  
                                <div class="another ">
                                    <a href="javascript:void(0)" style="padding-left: 12px; text-decoration:none;" class="add_button" ><b>+</b> Add New Custom Field</a>
                                </div>
                                        
                                </div>    
                            </div>
                                
                            <div class="text_fileld_wrap" style="background:#fafafa !important;">
                                <div class="page_title">My Gig Extras</div>   
                                <div class="text_fileld_wrap_ext">
                                    <?php
                                    //pr($gigDetail['Gigrequirement']);
                                    if (count($recordExtInfo) > 0) {
                                        $extno = 0;
                                        foreach ($recordExtInfo as $ekey => $gigext) {
                                            $currtime = time();
                                            $currid = $currtime . $ekey;
                                            $extno = $extno + 1;
                                            ?>
                                            <div id="extra_box_<?php echo $extno; ?>" class="answer_div answer_div_new">
                                                <?php //if ($extno != 1) { ?>
                                                <a class="delete-btn" href="javascript:void(0)" onclick="deleteextra(<?php echo $extno; ?>)"><i class="fa fa-trash"></i></a>
                                                <?php //} ?>
                                                    <div class="gigs-inputs">
                                                <?php echo e(Form::text('exttitle', $gigext->title, ['name' => 'exttitle[' . $extno . ']', 'id' => 'faqextttl_' . $extno, 'class'=>'form-control faqques required', 'minlength' => 5, 'maxlength' => 80, 'placeholder'=>'Title your extra service', 'autocomplete'=>'OFF'])); ?>

                                                    </div>
                                                   <div class="gigs-inputs">
                                                <?php echo e(Form::textarea('extdescription', $gigext->description, ['name' => 'extdescription[' . $extno . ']', 'id' => 'faqextdes_' . $extno, 'minlength' => 5, 'class'=>'form-control faqans texta required', 'placeholder'=>"Describe your offering"])); ?>
                                                ...
                                                <div class="drop_arow">
                                                    <div class="market-select">
                                                        <span>
                                                    <?php global $delivery_days; ?>
                                                    <?php echo e(Form::select('extdelivery', $delivery_days, $gigext->delivery, ['name' => 'extdelivery[' . $extno . ']', 'id' => 'faqextdel_' . $extno, 'class' => 'form-control required','placeholder' => 'Delivery Time'])); ?>
                                                ...
                                                <div class="drop_arow">
                                                    <div class="market-select">
                                                        <span>
                                                    <?php global $package_price; ?>
                                                    <?php echo e(Form::select('extprice', $package_price, $gigext->price, ['name' => 'extprice[' . $extno . ']', 'id' => 'faqextprc_' . $extno, 'class' => 'required form-control','placeholder' => 'Select Price'])); ?>
                                    ...
                                    /*else{ $extno  =1; ?>
                                        <div id="extra_box_<?php echo $extno; ?>" class="answer_div extra-gig-box">
                                                <?php if ($extno != 1) { ?>
                                                    <a href="javascript:void(0)" onclick="deleteextra(<?php echo $extno; ?>)"><i class="fa fa-trash"></i></a>
                                                <?php } ?>
                                                {{Form::text('exttitle', null, ['name' => 'exttitle[' . $extno . ']', 'id' => 'faqextttl_' . $extno, 'class'=>'faqques required', 'minlength' => 5, 'maxlength' => 80, 'placeholder'=>'Title your extra service', 'autocomplete'=>'OFF'])}}
                                                {{Form::text('extdescription', null, ['name' => 'extdescription[' . $extno . ']', 'id' => 'faqextdes_' . $extno, 'class'=>'faqans required', 'minlength' => 5, 'maxlength' => 80, 'placeholder'=>'Describe your offering', 'autocomplete'=>'OFF'])}}
                                                <span class="drop_arow">
                                                    <?php global $delivery_days; ?>
                                                    {{Form::select('extdelivery', $delivery_days,null, ['name' => 'extdelivery[' . $extno . ']', 'id' => 'faqextdel_' . $extno, 'class' => 'required','placeholder' => 'Delivery Time'])}}
                                                </span>
                                                <span class="drop_arow">
                                                    <?php global $package_price; ?>
                                                    {{Form::select('extprice', $package_price,null, ['name' => 'extprice[' . $extno . ']', 'id' => 'faqextprc_' . $extno, 'class' => 'required','placeholder' => 'Select Price'])}}
                                                </span>
                                            </div>
                                    <?php } */
                                    ?>
                                </div>
                                <div class="another"><a href="javascript:void(0)" onclick="addmoreextra()"><b>+</b> Add Extra</a></div>
                            </div>
                            <div class="page_btn page_btn_creat">
                                <!--<a href="<?php echo e(URL::to( 'users/dashboard')); ?>" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>-->
                                <?php echo e(Form::button('Back', ['class' => 'cancel_btn', 'id'=>'backstep_1'])); ?>

                                <?php echo e(Form::submit('Save &amp; Continue', ['class' => 'btn btn-info', 'id'=>'step_3'])); ?>

                                <!--<div class="gig_loader"  style="display: none;" id="loaderID"><img src="<?php echo e(asset('public/img/loading.gif')); ?>" /></div>-->
                                <div class="gig_loader" style="display:none;" id="loaderID"><img src="<?php echo e(asset('public/img/loading.gif')); ?>" /></div>
                            </div>
                        </div>
                        <div class="step_form_inner third_page step_account3" id="gig_description">
                            ...
                            <div class="descrp_text">
                                ...
                                <?php echo e(Form::textarea('description', null, ['minlength' => 120, 'maxlength' => 1200, 'class'=>'required', 'placeholder'=>"Description"])); ?>
                                                ...
                                                <div class="accordion-section">
                                                    ...
                                                    <div id="accordion-<?php echo $currid; ?>" class="accordion-section-content">
                                                        <div class="form_fieldd">
                                                            <?php echo e(Form::text('question', $gigfaqques->question, ['name' => 'question[]', 'id' => 'faqques_' . $currid, 'class'=>'form-control faqques required', 'minlength' => 5, 'maxlength' => 80, 'placeholder'=>'Add a Question: i.e. Do you translate to English as well?', 'autocomplete'=>'OFF'])); ?>

                                                            <?php echo e(Form::textarea('answer', $gigfaqques->answer, ['name' => 'answer[]', 'id' => 'faqans_' . $currid, 'minlength' => 5, 'maxlength' => 300, 'class'=>'form-control faqans texta required', 'placeholder'=>"Add an Answer: i.e. Yes, I also translate from English to Hebrew."])); ?>
                                                        ...
                                                        <div class="text_btn">
                                                            ...
                                                            <?php echo e(Form::button('Cancel', ['class' => 'btn-standard btn-green-grad btn-cancel-faq', 'id'=>'faqcan_'.$currid, 'onclick'=>'cancelfaq('.$currid.')'])); ?>

                                                            <?php echo e(Form::button('update', ['class' => 'btn-standard btn-white-grad btn-add-faq', 'id'=>'faqsub_'.$currid, 'onclick'=>'updatefaq('.$currid.')'])); ?>
                            ...
                            <div class="page_btn page_btn_creat">
                                <?php echo e(Form::button('Back', ['class' => 'cancel_btn', 'id'=>'backstep_2'])); ?>

                                <?php echo e(Form::submit('Save &amp; Continue', ['class' => 'btn btn-info', 'id'=>'step_4'])); ?>
                        ...
                        <div class="step_form_inner fourth_page step_account4" id="gig_requirement">
                                    ...
                                    if (count($recordReqInfo) > 0) {
                                        ...
                                        foreach ($recordReqInfo as $rkey => $gigreq) {
                                            ...
                                            <div id="requirement_box_<?php echo $reqno; ?>" class="answer_div">
                                                ...
                                                <?php } ?>
                                                <?php echo e(Form::textarea('reqdescription', $gigreq->description, ['name' => 'reqdescription[' . $reqno . ']', 'id' => 'faqreq_' . $reqno, 'minlength' => 5, 'maxlength' => 300, 'class'=>'required', 'placeholder'=>"For example: specifications, dimensions, brand guidelines, or background materials."])); ?>
                                        ...
                                        <div id="requirement_box_1" class="answer_div">
                                            ...
                                            <?php echo e(Form::textarea('reqdescription', null, ['name' => 'reqdescription[1]', 'id' => 'faqreq_1', 'minlength' => 20, 'maxlength' => 450, 'class'=>'required', 'placeholder'=>"For example: specifications, dimensions, brand guidelines, or background materials."])); ?>
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <?php echo e(Form::button('Back', ['class' => 'cancel_btn', 'id'=>'backstep_3'])); ?>

                                <?php echo e(Form::submit('Save &amp; Continue', ['class' => 'btn btn-info', 'id'=>'step_5'])); ?>
                        ...
                        <div class="step_form_inner fifth_page step_account5" id="gig_gallery">
                                ...
                                <div class="wiz_cols_nw">
                                        ...
                                        <div class="form_row_fhr_cols" id="<?php echo $key; ?>imagediv">
                                            <div class="shoe_imagrd_rgijt_img">
                                                <div class="shoe_imagrd_rgijt_img_minimg">
                                                    <a href="javascript: void(0)" class="btn btn-primary ad_cls_img close_btn<?php echo $imgid; ?>" onclick="deleteimage(<?php echo $value->id;?>)"><i class="fa fa-close"></i></a>
                                                    <?php
                                                    $filePath = GIG_FULL_UPLOAD_PATH . $value->name;
                                                     ?>
                                                    <?php if(file_exists($filePath) && $value->name != ''): ?>
                                                        <?php echo e(HTML::image(GIG_SMALL_DISPLAY_PATH.$value->name, SITE_TITLE,['id' => 'ShowImage' . $imgid, 'style'=>"max-width: 100%", 'class' => 'umg_ahe'])); ?>

                                                    <?php else: ?> 
                                                        <?php echo e(HTML::image('public/img/front/no_image.png', SITE_TITLE,['id' => 'ShowImage' . $imgid, 'style'=>"max-width: 100%", 'class' => 'umg_ahe'])); ?>

                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="shoe_imagrd_rgijt" id="ShowImage<?php echo $imgid; ?>_div">
                                                <span class="inline-gsj">
                                                    ...
                                                    <?php echo e(Form::file('image[]', ['class' => 'images', 'id' => 'image' . $key, 'class'=>'form-control', 'accept'=>IMAGE_EXT])); ?>
                                    ...
                                    for ($key = $i; $key < 3; $key++) {
                                        ...
                                        <div class="form_row_fhr_cols" id="<?php echo $key; ?>imagediv">
                                            <div class="shoe_imagrd_rgijt_img">
                                                <div class="shoe_imagrd_rgijt_img_minimg">
                                                        <a href="javascript: void(0)" class="btn btn-primary ad_cls_img close_btn<?php echo $imgid; ?>" style="display:none;"><i class="fa fa-close"></i></a>
                                                        <?php echo e(HTML::image('public/img/front/no_image.png', SITE_TITLE,['id' => 'ShowImage' . $imgid, 'style'=>"max-width: 100%", 'class' => 'umg_ahe'])); ?>
                            ...
                            <div class="gig_video">
                                ...
                                <div class="form_fieldd">
                                    <?php echo e(Form::text('youtube_url', null, ['class'=>'yturl', 'autocomplete'=>'OFF'])); ?>
                            ...
                            <div class="gig_video gig_pdf">
                                ...
                                <div class="gig_attach_box">
                                    <?php echo e(Form::file('files_name', ['class' => 'images', 'id'=>'add_logo', 'class'=>'form-control file-item', 'accept'=>DOC_EXT])); ?>
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <?php echo e(Form::button('Back', ['class' => 'cancel_btn', 'id'=>'backstep_4'])); ?>

                                <?php echo e(Form::submit('Save &amp; Continue', ['class' => 'btn btn-info', 'id'=>'step_6'])); ?>
                        ...
                        <div class="step_form_inner fifth_page step_account6" id="gig_publish">
                            ...
                            <div class="page_btn">
                                <?php echo e(Form::button('Back', ['class' => 'cancel_btn', 'id'=>'backstep_5'])); ?>

                                <?php echo e(Form::submit('Save & Publish', ['class' => 'btn btn-info', 'id'=>'step_7'])); ?>
...
<script type="text/javascript">
  ...
  var checkBox = document.getElementById("someSwitchOptionSuccess");
  // Get the output text
  var form1 = document.getElementById("fixed");
  var form2 = document.getElementById("standard");
  var addCustom = document.getElementById("addField");
  var heading =document.getElementById("heading");
  var gfp = document.getElementById("gig_fixed_price");
  var gfr = document.getElementById("gig_fixed_revision");
  var gfd = document.getElementById("gig_fixed_del");

  // If the checkbox is checked, display the output text
  if (checkBox.checked == true){
    form1.style.display = "block";
    form2.style.display = "none";
    heading.innerText = "Pricing";
    ...
    heading.innerText = "Packages";
    gfp.value = "null";
    gfr.value = "null";
    gfd.value = "null";
    form2.style.display = "block";
    form1.style.display = "none";
    addCustom.style.display = "block";
    $('#fixed_row1').remove();
    $('#fixed_row2').remove();
    $('#fixed_row3').remove();
    $('#fixed_row4').remove();
    $('#fixed_row5').remove();
    <?php $recordCustInfo = 0; ?>
  }
}
</script>
<script>
    ...
    function addmoreextra() {
        ...
        for(p = 5;p < 1000;){
            faqnav += '<option value='+p+'><?php echo e(CURR); ?>'+p+'</option>';
            p = parseInt(p)+5;
        }
        faqnav += '</select>';
        faqnav += '</span></div></div></div>';
...
<?php echo $__env->make('layouts.inner2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seenshop/laravelvue.seenshop.com/resources/views/gigs/edit.blade.php ENDPATH**/ ?>