...
<?php echo e(HTML::style('./css/front/card.css')); ?>

<?php echo e(HTML::script('./js/creditCardValidator.js')); ?>
...
<script>
    function paywithcard() {
      if (cardFormValidate()) {
            ...
            $.ajax({
                url: "<?php echo HTTP_PATH; ?>/payments/paywithcard",
                type: "POST",
                data: $('#paymentForm').serialize(),
                success: function (result) {
                    if(result == 1){
                        window.location = "<?php echo HTTP_PATH; ?>/buying-orders";
                    }else{
                        $('#gigdloader').hide();
                        $('#btndivecard').show();
    ...
    function payviawallet() {
        if (confirm('Please do not refresh or click borwser back button.') == true) {
            ...
            $('#gigdloader').show();
            $.ajax({
                url: "<?php echo HTTP_PATH; ?>/payments/payviawallet",
                type: "POST",
...
<?php echo $__env->make('layouts.inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jaimebalatero/Desktop/prozed/laravelvue/09-14-20/resources/views/payments/ordersummary.blade.php ENDPATH**/ ?>