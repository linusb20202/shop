...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Edit <?php echo $catInfo->name; ?> Sub Category</h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo e(URL::to('admin/admins/dashboard')); ?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
            <li><a href="<?php echo e(URL::to('admin/categories/subcategory/'.$catInfo->slug)); ?>"><i class="fa fa-sitemap"></i> <span>Sub Categories</span></a></li>
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <!--<?php echo e(Form::textarea('sub_description', null, ['class'=>'form-control ', 'placeholder'=>'Full Sub-Category Description', 'autocomplete' => 'off', 'rows'=> '2'])); ?>-->
                            <?php echo e(Form::textarea('sub_description', null, ['minlength' => 120, 'maxlength' => 1200, 'class'=>'form-control required', 'placeholder'=>"Full Sub-Category Description"])); ?>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo e(URL::to( 'admin/categories/subcategory/'.$catInfo->slug)); ?>" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seenshop/laravel.seenshop.com/resources/views/admin/categories/editsubcategory.blade.php ENDPATH**/ ?>