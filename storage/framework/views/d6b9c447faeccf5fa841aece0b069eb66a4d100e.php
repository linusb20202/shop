...
<div class="detai_page">
    ...
    <div class="login-wapper ddreg">        
        <div class="login-bg">  
            <div class="signn">Create your Account </div>
            ...
            <div normal_login>
                ...
                <div class="login_fieldarea">
                    <div class="inputt">
                        ...
                        <span class="fieldd">
                            <?php echo e(Form::text('user_name', null, ['class'=>'form-control required alphanumeric', 'placeholder'=>'Username', 'autocomplete'=>'OFF'])); ?>

                        </span>
                        <span class="help-text" style="margin-top:10px;">Note: You will not be able to change username once your account has been created.</span>
                    </div>
                    <div class="inputt">
                        <span class="fieldd">
                    ...
                    <div class="sign_in" id="sub_btn_dive">
                        ...
                        <span class="help-text" style="margin-top:10px;">By joining I agree to receive emails from Preffort.</span>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seenshop/laravel.seenshop.com/resources/views/users/register.blade.php ENDPATH**/ ?>