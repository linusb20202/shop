...
<div class="content-wrapper">
    <section class="content-header">
        <h1><?php echo e($userInfo->first_name.' '.$userInfo->first_name); ?> > Wallet</h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="m_content" id="listID">
                <?php echo $__env->make('elements.admin.wallets.history', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </section>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seenshop/laravel.seenshop.com/resources/views/admin/wallets/history.blade.php ENDPATH**/ ?>