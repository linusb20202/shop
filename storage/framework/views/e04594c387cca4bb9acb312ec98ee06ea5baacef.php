...
<script type="text/javascript">
    ...
    gallery: true,
            ...
            var firstScriptTag = document.getElementsByTagName('script')[0];e
            ...
            <div class="row">
                <div class="col-xs-12 col-md-8">
                        ...
                        <div class="row">
                            <div class="col-xs-7 md-7" >
                                ...
                                <div class="about-rating" style="margin-botom:0px;padding:bottom:0px;align-items:end;">
                                            ...
                                            <span style="color:#D0D0D0; font-size:14px;vertical-align:bottom;font-weight:600"><b><?php echo $recordInfo->User->average_rating; ?></b> (<?php echo $recordInfo->User->total_review; ?>)</span>&nbsp; <span style="color:#D0D0D0; font-size:14px;vertical-align:bottom;font-weight:600">0 Order(s) in Queue.</span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td class="text-center">
                                        ...
                                        <input type="hidden" name="type" id="standard" value="standard">
                                        <input type="hidden" name="slug"  value="<?php echo e($recordInfo->slug); ?>">
                                      ...
                                      <td class="text-center">
                                        ...
                                        <input type="hidden" name="type" id="standard" value="premium">
                                        <input type="hidden" name="slug"  value="<?php echo e($recordInfo->slug); ?>">
                        ...
                        <div class="row">
                            <div class="col-xs-12 md-12"  >
                                <div class="gig-page-packages-table" id="related"><h3 class="section-title" style="margin-bottom:15px;margin-top:15px;">Other Gigs Offered By <span style="color:#5CB85C;"><a href="../public-profile/<?php echo e($recordInfo->User->slug); ?>" style="color:#5CB85C;"><?php echo e($recordInfo->User->user_name); ?></a></span></h3>
...
<?php echo $__env->make('layouts.dashboard2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jaimebalatero/Desktop/prozed/laravelvue/09-14-20/resources/views/gigs/detail.blade.php ENDPATH**/ ?>