        ...
        <div class="tbl-resp-listing">
            <table class="table table-bordered table-striped table-condensed cf">
                <thead class="cf ddpagingshorting">
                    <tr>
                        <th style="width:5%">#</th>
                        <th class="sorting_paging"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('first_name', 'First Name'));?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-title="Full Name"><?php echo e($allrecord->first_name); ?></td>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH /home/seenshop/laravel.seenshop.com/resources/views/elements/admin/users/index.blade.php ENDPATH**/ ?>