<table width="710" align="center" style="table-layout:fixed; font-family:Arial, Helvetica, sans-serif; border:1px solid #537286; box-shadow: 0 0 5px #537286; padding:10px 15px;">
    <tbody><tr>
            <td valign="top" style=" background-color: #e8edea;">
                <table width="100%">
                    <tbody><tr>
                            <td>
        ...
        <tr>
            <td valign="top">
                <!-- Begin Footer -->
                <table width="100%" style="border-top:1px solid #ddd; background-color:#03a637; color: #0B0B0B;">
                    <tbody><tr>
                            <td style="font-size:12px;">
                                <p style="color:#ffffff; width:100%;">&nbsp;Copyright &copy; <?php echo date('Y'); ?> <?php echo SITE_TITLE; ?> All Rights Reserved.</p>
                            ...
                            <td align="right">
                                <a href="<?php echo e(HTTP_PATH); ?>"><?php echo e(HTML::image(LOGO_PATH, SITE_TITLE)); ?></a>
                            </td>
                        </tr>
                    </tbody></table>
                <!-- End Footer -->
...
</table><?php /**PATH /Users/jaimebalatero/Desktop/prozed/laravelvue/09-14-20/resources/views/emails/emailtemplate.blade.php ENDPATH**/ ?>