            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <!--<?php echo e(Form::textarea('full_description', null, ['class'=>'form-control alpha', 'placeholder'=>'Full description for Category', 'autocomplete' => 'off', 'max-length' => '255', 'rows'=> '2'])); ?>-->
                            <?php echo e(Form::textarea('full_description', null, ['minlength' => 120, 'maxlength' => 1200, 'class'=>'form-control required', 'placeholder'=>"Full description for Category"])); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo e(Form::text('description', null, ['class'=>'form-control', 'placeholder'=>'Short description', 'autocomplete' => 'off'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seenshop/laravel.seenshop.com/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>